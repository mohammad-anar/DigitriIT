          ...
          <form>
            <div className="bg-white flex items-stretch justify-between rounded-2xl overflow-hidden max-w-100%">
              <input
                ...
                className="text-black p-4 py-2 w-[80%]"
              />
              <button className="text-white bg-blue-600 p-4 h-full w-[20%]">
                <FaPaperPlane values="color: #000" />
              </button>
            </div>
          </form>
        </div>
        <h6 className="footer-title mt-4">Follow Us</h6>
        <div className="flex items-center gap-4 justify-center mt-2 text-blue-600">
